...
draw(combined, original, color=(255, 0, 255))
...
# TODO-- Create a circle around each point, and create a weighting to show how important each point may be?
# maybe do the circle thing, and choose the point that's closest to being  at zero degrees (pi chart)
# this means whatever is closest to a hypothetical, horizontal line heading to the right
